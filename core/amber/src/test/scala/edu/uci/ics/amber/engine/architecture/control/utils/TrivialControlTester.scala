...
class TrivialControlTester(id: ActorVirtualIdentity, parentNetworkCommunicationActorRef: ActorRef) extends WorkflowActor(id, parentNetworkCommunicationActorRef) {
